(() => {
  ...
  var ErrorPopup = /* @__PURE__ */ __name((props) => {
    const timeoutId = !props.showButton ? setTimeout(
      () => {
        if (props.messageTosend) {
          try {
            ...
            console.error("Error while sending runtime message");
          }
        }
      },
      props.timeoutTime ? props.timeoutTime : 3e3
    ) : null;
    const handleClosePopup = /* @__PURE__ */ __name(() => {
      if (chrome.runtime) {
    ...
    return /* @__PURE__ */ import_react.default.createElement(
      "div",
      {
        ...
        className: "verified-custd-ext-success-popup-content-container"
      },
      /* @__PURE__ */ import_react.default.createElement("div", { className: "verified-custd-ext-success-popup-content" }, /* @__PURE__ */ import_react.default.createElement(
        "img",
        {
          style: { width: "35%" },
      ...
      ), /* @__PURE__ */ import_react.default.createElement("div", { className: "verified-custd-ext-success-popup-content-text" }, /* @__PURE__ */ import_react.default.createElement("p", { className: "verified-custd-ext-success-popup-content-text-header" }, !props?.showButton ? props.customTextHeader : props.actionHeaderText), /* @__PURE__ */ import_react.default.createElement("p", { className: "verified-custd-ext-success-popup-content-text-footer" }, !props?.showButton ? props.customTextFooter : props.actionFooterText))),
      props.showButton && props.buttonText?.length > 0 && /* @__PURE__ */ import_react.default.createElement(
        "button",
        {
          ...
          className: "verified-custd-ext-startup-button-active"
        },
        props.buttonText
      ),
      props.showButton && props.buttonNeutText?.length > 0 && /* @__PURE__ */ import_react.default.createElement(
        "button",
        {
          style: { marginTop: "10px", fontSize: "14px" },
          onClick: () => {
          ...
          className: "verified-custd-ext-startup-button-click"
        },
        props.buttonNeutText
      )
    );
  }, "ErrorPopup");
  var SuccessPopup = /* @__PURE__ */ __name((props) => {
    const timeoutId = !props.showButton ? setTimeout(
      () => {
        if (props.messageTosend) {
          try {
    ...
    return /* @__PURE__ */ import_react.default.createElement(
      ...
      /* @__PURE__ */ import_react.default.createElement("div", { className: "verified-custd-ext-success-popup-content" }, /* @__PURE__ */ import_react.default.createElement(
        ...
        {
          style: { width: "90%" },
          src: "../assets/succes-page-icon.svg",
          alt: "Success Icon"
        }
      ), /* @__PURE__ */ import_react.default.createElement("div", { className: "verified-custd-ext-success-popup-content-text" }, /* @__PURE__ */ import_react.default.createElement("p", { className: "verified-custd-ext-success-popup-content-text-header" }, !props?.showButton ? props.customTextHeader : props.actionHeaderText), /* @__PURE__ */ import_react.default.createElement("p", { className: "verified-custd-ext-success-popup-content-text-footer" }, !props?.showButton ? props.customTextFooter : props.actionFooterText))),
      props.showButton && props.buttonText?.length > 0 && /* @__PURE__ */ import_react.default.createElement(
